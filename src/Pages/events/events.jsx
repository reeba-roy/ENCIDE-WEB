      ...
      <div className="container relative z-10 px-4 mx-auto md:px-8 lg:px-16">
        ...
        {featuredEvent && (
          <motion.div
            ...
            className="mb-8"
          >
            <div className="relative overflow-hidden transition-all duration-500 border rounded-2xl border-neutral-800 backdrop-blur-sm group hover:border-red-500/30">
              <div className="absolute inset-0 transition-opacity duration-500 opacity-0 pointer-events-none rounded-2xl bg-gradient-to-r from-red-500/5 via-transparent to-red-500/5 group-hover:opacity-100" />
              ...
              <div className="flex flex-col h-full sm:flex-row">
                ...
                <div className="flex flex-col justify-center flex-1 min-w-0 p-5">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 mt-auto text-sm font-medium text-white transition-all duration-300 border rounded-lg w-fit bg-neutral-800 hover:bg-red-600 group/btn border-neutral-700 hover:border-red-500 hover:shadow-lg hover:shadow-red-500/20"
                  >
                    Register Now
